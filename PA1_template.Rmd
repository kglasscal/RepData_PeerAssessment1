...
[`r format(round(mean(dailySourceSteps$total, na.rm = TRUE), 0), nsmall = 0)`]{style="color:green; font-weight: bold"}.
The median number of steps per day is [
`r format(round(median(dailySourceSteps$total, na.rm = TRUE), 2), nsmall = 2)`]{style="color:green; font-weight: bold"}.
...
[`r format(round(maxInterval, 0), nsmall = 0)`]{style="color:green; font-weight: bold"}.
...
`r format(round(nNAValues, 0), nsmall = 0)`]{style="color:green; font-weight: bold"}.
...
The mean number of steps per day is [
`r format(round(mean(dailyImputedSteps$total, na.rm = TRUE), 2), nsmall = 2)`]{style="color:green; font-weight: bold"}


The median number of steps per day is [
`r format(round(median(dailyImputedSteps$total, na.rm = TRUE), 2), nsmall = 2)`]{style="color:green; font-weight: bold"}.
...
The first part estimated the mean and median as [`r format(round(mean(dailySourceSteps$total, na.rm = TRUE), 0), nsmall = 0)`]{style="color:green; font-weight: bold"} and [`r format(round(median(dailySourceSteps$total, na.rm = TRUE), 0), nsmall = 0)`]{style="color:green; font-weight: bold"} respectively.
...
*integralWeekdaySteps* = `r format(round(intervalWeekdayTotal, 0), nsmall = 0)`  
*integralWeekendSteps* = `r format(round(intervalWeekendTotal, 0), nsmall = 0)`

and the ratio of weekday and weekend steps is [ 
`r format(round(intervalWeekdayTotal/intervalWeekendTotal, 2), nsmall = 2)`
